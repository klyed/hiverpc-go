...
// FC_REFLECT( hive::chain::report_over_production_operation,
//             (reporter)
//             (first_block)
//             (second_block) )
...
// FC_REFLECT( hive::chain::convert_operation,
//             (owner)
//             (requestid)
//             (amount) )
...
// FC_REFLECT( hive::chain::feed_publish_operation,
//             (publisher)
//             (exchange_rate) )
...
// FC_REFLECT( hive::chain::pow_operation,
//             (worker_account)
//             (block_id)
//             (nonce)
//             (work)
...
// FC_REFLECT( hive::chain::account_create_operation,
//             (fee)
//             (creator)
//             (new_account_name)
//             (owner)
...
// FC_REFLECT( hive::chain::account_update_operation,
//             (account)
//             (owner)
//             (active)
//             (posting)
...
// FC_REFLECT( hive::chain::transfer_operation,
//             (from)
//             (to)
//             (amount)
//             (memo) )
...
// FC_REFLECT( hive::chain::transfer_to_vesting_operation,
//             (from)
//             (to)
//             (amount) )
...
// FC_REFLECT( hive::chain::withdraw_vesting_operation,
//             (account)
//             (vesting_shares) )
...
// FC_REFLECT( hive::chain::set_withdraw_vesting_route_operation,
//             (from_account)
//             (to_account)
//             (percent)
//             (auto_vest) )

// FC_REFLECT( hive::chain::witness_update_operation,
//             (owner)
//             (url)
//             (block_signing_key)
//             (props)
...
// FC_REFLECT( hive::chain::account_witness_vote_operation,
//             (account)
//             (witness)(approve) )
...
// FC_REFLECT( hive::chain::account_witness_proxy_operation,
//             (account)
//             (proxy) )
...
// FC_REFLECT( hive::chain::comment_operation,
//             (parent_author)
//             (parent_permlink)
//             (author)
//             (permlink)
...
// FC_REFLECT( hive::chain::vote_operation,
//             (voter)
//             (author)
//             (permlink)
//             (weight) )
...
// FC_REFLECT( hive::chain::custom_operation,
//             (required_auths)
//             (id)
//             (data) )

// FC_REFLECT( hive::chain::limit_order_create_operation,
//             (owner)
//             (orderid)
//             (amount_to_sell)
//             (min_to_receive)
...
// FC_REFLECT( hive::chain::limit_order_cancel_operation,
//             (owner)
//             (orderid) )
...
// FC_REFLECT( hive::chain::delete_comment_operation,
//             (author)
//             (permlink) )
...
// FC_REFLECT( hive::chain::comment_options_operation,
//             (author)
//             (permlink)
//             (max_accepted_payout)

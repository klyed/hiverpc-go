...
type Config struct {
	HiveBlockchainHardforkVersion string `json:"HIVE_BLOCKCHAIN_HARDFORK_VERSION"`
	HiveBlockchainVersion         string `json:"HIVE_BLOCKCHAIN_VERSION"`
	HiveBlockInterval             uint   `json:"HIVE_BLOCK_INTERVAL"`
}
